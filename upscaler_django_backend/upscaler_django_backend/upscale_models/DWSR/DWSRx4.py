...
import numpy as np
from upscaler_django_backend.upscale_models.DWSR.netx4 import model 
import cv2
import pywt as pw
import ntpath

TEST_EXPERIMENT = True
# MODEL_PATH = './Weightx4/x4.ckpt'  # Zaktualizuj ścieżkę zgodnie z faktyczną lokalizacją pliku
MODEL_PATH = 'upscaler_django_backend/upscale_models/DWSR/Weightx4/x4.ckpt'
WV = 'db1'

def process_image_x4(input_image_path, output_dir):
