...
Do implementacji Frontendu zdecydowałem się na użycie frameworku \textbf{Vue.js} \cite{vue}.
...
Do implementacji Frontendu korzystałem z rowiązań bibliotek \textbf{Vue.js} \cite{vue}, \textbf{fontaswesome} \cite{fonta} i \textbf{Heroicons} \cite{heroicons} do ikon, \textbf{Adobe Fonts} \cite{adobefonts} i \textbf{Google Fonts} \cite{googlefonts} do czcionek oraz \textbf{Tailwind CSS} \cite{tailwind} do stylowania aplikacji.
