...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        \addplot3+[mesh, samples=30] table {Rozdziały/02.Podstawy_teoretyczne/wave_data.txt}; % Wczytanie danych
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[ht]
    ...
    \begin{minipage}[t]{0.47\linewidth}
        \includegraphics[width=\linewidth]{Rozdziały/02.Podstawy_teoretyczne/morlet_bez_przesuniecia.png}
        \caption{Brak przesunięcia}
        \label{fig:image34}
    \end{minipage}
    \centering
    \begin{minipage}[t]{0.47\linewidth}
        \includegraphics[width=\linewidth]{Rozdziały/02.Podstawy_teoretyczne/time_shift_morlet.png}
...
\begin{figure}[ht]
    ...
    \begin{minipage}[t]{0.46\linewidth}
        \includegraphics[width=\linewidth]{Rozdziały/02.Podstawy_teoretyczne/f_shift_morlet.png}
        \caption{Przesunięcie w częstotliwości}
        \label{fig:image36}
    \end{minipage}
    \centering
    \begin{minipage}[t]{0.46\linewidth}
        \includegraphics[width=\linewidth]{Rozdziały/02.Podstawy_teoretyczne/t_and_f_shift_morlet.png}
...
W rezultacie funkcja $T\left(a,b\right)$ składa się na mapę współczynników, która jest reprezentacją sygnału w dziedzinie czasu i częstotliwości. Mapę taką nazywamy skalogramem, skalogram przykładowego sygnału przedstawiono na Rys \ref{fig:image38} i \ref{fig:image39}.

\begin{figure}[ht]
    \centering
    \begin{minipage}[t]{0.9\linewidth}
        \includegraphics[width=\linewidth]{Rozdziały/02.Podstawy_teoretyczne/skalogram.png}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=0.95]
        ...
        \addplot3[surf] file {Rozdziały/02.Podstawy_teoretyczne/wavelet_coefficients_magnitude.txt};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[ht]
    ...
    \begin{minipage}[t]{0.57\linewidth}
        \includegraphics[width=\linewidth]{Rozdziały/02.Podstawy_teoretyczne/skalogram_sinus.png}
...
W praktyce, transformacja falkowa jest stosowana do analizy sygnałów cyfrowych, które są dyskretne w czasie. W takim przypadku, transformacja falkowa jest dyskretna, co oznacza, że sygnał jest analizowany w dyskretnych punktach czasu. W rezultacie, transformacja falkowa jest dyskretną funkcją, która jest obliczana w dyskretnych punktach czasu i częstotliwości.
