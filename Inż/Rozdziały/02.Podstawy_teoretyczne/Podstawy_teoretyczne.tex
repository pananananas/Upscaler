...
W efekcie polega to na wyznaczeniu średniej ważonej pikseli sąsiadujących z pikselem, który chcemy powielić. Współczynniki wag są wyznaczane na podstawie odległości od piksela, który chcemy powielić. Metody te dają lepsze rezultaty niż interpolacja najbliższego sąsiada, jednakże nie są one wystarczające do uzyskania obrazu o wysokiej rozdzielczości. 
...
W efekcie otrzymujemy obraz wyglądający następująco [Rys \ref{fig:image8}].
...
\begin{figure}[ht]
    ...
    \begin{minipage}[t]{0.35\linewidth}
        ...
        \caption{Obraz powiększony interpolacją dwuliniową}
        \label{fig:image10}
    \end{minipage}
\end{figure}
