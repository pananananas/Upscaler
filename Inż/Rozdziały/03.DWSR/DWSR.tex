...
Sieć DWSR charakteryzuje się niewielkim czasem działania, co zapewnia relatywnie niewielka ilość parametrów w porównaniu z innymi metodami SR. Algorytm DWSR również świetnie radzi sobie z rekonstrukcją szczegółów obrazu, zwłaszcza w przypadku stałych krawędzi i tekstur.
